  ...
  if (tokenError === "RefreshAccessTokenError") {
    return (
      <div style={{ padding: "40px", textAlign: "center" }}>
        ...
        <h2 style={{ fontFamily: FONT, fontSize: "14px", color: C.text, marginBottom: "20px" }}>
          [ SESSION EXPIRED ]
        </h2>
      ...
      <main style={{ padding: "20px" }}>
        ...
        {step === "find_clinics" && (
          <div style={{ ...panel, background: C.bgDark, padding: "24px", textAlign: "center" }}>
            ...
            <div style={{ fontSize: "10px", color: C.muted, marginBottom: "24px", fontFamily: "monospace" }}>
        ...
        {step === "done" && bookedEvent && (
          <div style={{ textAlign: "center", padding: "20px" }}>
            <div style={{ fontSize: "50px", marginBottom: "20px" }}>✅</div>
            <h2 style={{ fontFamily: FONT, fontSize: "14px", color: C.green, marginBottom: "20px" }}>[ APPOINTMENT SET ]</h2>
            ...
            <div style={{ ...panel, background: C.bgDark, padding: "24px", marginBottom: "24px" }}>
              ...
              <p style={{ fontFamily: "monospace", fontSize: "13px", fontWeight: "bold", color: C.text, marginBottom: "8px" }}>
                {formatDate(bookedEvent.start).toUpperCase()}
              </p>
              <p style={{ fontFamily: "monospace", fontSize: "13px", color: C.text }}>
